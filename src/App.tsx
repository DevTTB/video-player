...
import { VideoPlayers } from "@/components/video-player/qwe.tsx";
...
export const App = () => {
  ...
  return (
    <Box width={"100%"} height={"56.25vw"} maxHeight={"calc(100vh - 169px)"} backgroundColor={"black"} >
      ...
      {/* <VideoPlayers src={"https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"} /> */}
    </Box>
  )
}
